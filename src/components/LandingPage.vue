      ...
      >
        <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
          <div class="flex">
            ...
            >
              <span class="font-semibold text-indigo-600">Stay up to date</span>
          ...
          >
            Level up your trading with InnerTrader
          </h1>
          <p class="mt-6 text-lg leading-8 text-gray-600">
            Empower Your Trading Journey: Where Knowledge Fuels Opportunity, and
            Your Story Finds Voice. Explore our insightful journals and vibrant
            community forum to chart your path to success
          </p>
        ...
        <div class="mt-16 sm:mt-24 lg:mt-0 lg:flex-shrink-0 lg:flex-grow">
          ...
          >
            ...
            >
              <img img src="@/assets/tradingviewphone.png" alt="" />
            </foreignObject>
          </svg>
        </div>
      </div>
